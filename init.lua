...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>g', group = 'Guide', icon = { icon = '', color = 'green' } },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>gd', builtin.help_tags, { desc = 'Documentation' })
      vim.keymap.set('n', '<leader>gs', builtin.keymaps, { desc = 'Shortcuts' })
